...
// yy add the annotation for nameing conflict in compile
//#define max(a,b) (((a)>(b))?(a):(b))
//#define min(a,b) (((a)<(b))?(a):(b))
// if have to use self defined max and min function, use inline to replace the define
template <typename T>
